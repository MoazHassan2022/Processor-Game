...
; notification vars
notifyx dw ?    ;stores the current cursor position inside notifications area
welcomeUser db 'Welcome, ', '$'
; end of notification vars
...
; Keep writing in the notifications area without clearing anything with var(msg) ----> concatinate_Not
